...
{
    public class UpdateCustomerPersonFisCommand
        : Notifiable<Notification>, ICommand
    {
        public UpdateCustomerPersonFisCommand()
        {
        ...
        public IResponse Validate()
        {
            ...
            if (IsValid)
                return new ResponseOk<UpdateCustomerPersonFisCommand>(this, 1);

            return new ResponseError<UpdateCustomerPersonFisCommand>("400", "The data for insert the customer is incorrect.", Notifications, Notifications.Count);
        }
    }
}
