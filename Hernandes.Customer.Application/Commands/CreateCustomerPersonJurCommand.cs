...
{
    public class CreateCustomerPersonJurCommand
        : Notifiable<Notification>, ICommand
    {
        public CreateCustomerPersonJurCommand()
        {
        ...
        public IResponse Validate()
        {
            ...
            if (IsValid)
                return new ResponseOk<CreateCustomerPersonJurCommand>(this, 1);

            return new ResponseError<CreateCustomerPersonJurCommand>("400", "The data for insert the customer is incorrect.", Notifications, Notifications.Count);
        }
    }
}
