...
{
    [TestClass]
    [TestCategory("Command Validation")]
    public class CreateCustomerPersonFisCommandTest
    {
        ...
        private CreateCustomerPersonFisCommand FakeCommand(Dictionary<string, object> args = null) =>
            new CreateCustomerPersonFisCommand(
