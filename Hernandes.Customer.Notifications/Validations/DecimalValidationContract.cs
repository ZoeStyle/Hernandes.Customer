...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(decimal val, double comparer, string key) =>
            IsGreaterOrEqualsThan(val, (decimal)comparer, key, NotificationsErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(decimal val, double comparer, string key) =>
            IsLowerOrEqualsThan(val, (decimal)comparer, key, NotificationsErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(decimal val, string key) =>
            IsMinValue(val, key, NotificationsErrorMessages.IsMinValueErrorMessage(key, decimal.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(decimal val, string key) =>
            IsNotMinValue(val, key, NotificationsErrorMessages.IsNotMinValueErrorMessage(key, decimal.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(decimal val, string key) =>
            IsMaxValue(val, key, NotificationsErrorMessages.IsMaxValueErrorMessage(key, decimal.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(decimal val, string key) =>
            IsNotMaxValue(val, key, NotificationsErrorMessages.IsNotMaxValueErrorMessage(key, decimal.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(decimal val, int comparer, string key) =>
            AreEquals(val, (decimal)comparer, key, NotificationsErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(decimal val, int comparer, string key) =>
            AreNotEquals(val, (decimal)comparer, key, NotificationsErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(decimal val, int start, int end, string key) =>
            IsBetween(val, (decimal)start, (decimal)end, key, NotificationsErrorMessages.IsBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(decimal val, int start, int end, string key) =>
            IsNotBetween(val, (decimal)start, (decimal)end, key, NotificationsErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
        ...
        public Contract<T> Contains(decimal val, IEnumerable<decimal> list, string key) =>
            Contains(val, list, key, NotificationsErrorMessages.ContainsErrorMessage(key, val.ToString()));
        ...
        public Contract<T> NotContains(decimal val, IEnumerable<decimal> list, string key) =>
            NotContains(val, list, key, NotificationsErrorMessages.NotContainsErrorMessage(key, val.ToString()));
