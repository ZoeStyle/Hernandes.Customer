...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(float val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (float)comparer, key, NotificationsErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(float val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (float)comparer, key, NotificationsErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> AreEquals(float val, int comparer, string key) =>
            AreEquals(val, (float)comparer, key, NotificationsErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(float val, int comparer, string key) =>
            AreNotEquals(val, (float)comparer, key, NotificationsErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(float val, int start, int end, string key) =>
            IsBetween(val, (float)start, (float)end, key, NotificationsErrorMessages.IsBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(float val, int start, int end, string key) =>
            IsNotBetween(val, (float)start, (float)end, key, NotificationsErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
