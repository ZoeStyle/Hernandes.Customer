...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsBetween(TimeSpan val, TimeSpan start, TimeSpan end, string key) =>
            IsBetween(val, start, end, key, NotificationsErrorMessages.IsBetweenErrorMessage(key, start.ToString(), end.ToString()));
        ...
        public Contract<T> IsNotBetween(TimeSpan val, TimeSpan start, TimeSpan end, string key) =>
            IsNotBetween(val, start, end, key, NotificationsErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(), end.ToString()));
        ...
        public Contract<T> IsMinValue(TimeSpan val, string key) =>
            IsMinValue(val, key, NotificationsErrorMessages.IsMinValueErrorMessage(key, TimeSpan.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(TimeSpan val, string key) =>
            IsNotMinValue(val, key, NotificationsErrorMessages.IsNotMinValueErrorMessage(key, TimeSpan.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(TimeSpan val, string key) =>
            IsMaxValue(val, key, NotificationsErrorMessages.IsMaxValueErrorMessage(key, TimeSpan.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(TimeSpan val, string key) =>
            IsNotMaxValue(val, key, NotificationsErrorMessages.IsNotMaxValueErrorMessage(key, TimeSpan.MaxValue.ToString()));
