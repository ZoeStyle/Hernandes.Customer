...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(double val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (double)comparer, key, NotificationsErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(double val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (double)comparer, key, NotificationsErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(double val, string key) =>
            IsMinValue(val, key, NotificationsErrorMessages.IsMinValueErrorMessage(key, double.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(double val, string key) =>
            IsNotMinValue(val, key, NotificationsErrorMessages.IsNotMinValueErrorMessage(key, double.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(double val, string key) =>
            IsMaxValue(val, key, NotificationsErrorMessages.IsMaxValueErrorMessage(key, double.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(double val, string key) =>
            IsNotMaxValue(val, key, NotificationsErrorMessages.IsNotMaxValueErrorMessage(key, double.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(double val, int comparer, string key) =>
            AreEquals(val, (double)comparer, key, NotificationsErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(double val, int comparer, string key) =>
            AreNotEquals(val, (double)comparer, key, NotificationsErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(double val, int start, int end, string key) =>
            IsBetween(val, (double)start, (double)end, key, NotificationsErrorMessages.IsBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(double val, int start, int end, string key) =>
            IsNotBetween(val, (double)start, (double)end, key, NotificationsErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
