...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsFalse(bool val, string property) =>
            IsFalse(val, property, NotificationsErrorMessages.IsFalseErrorMessage(property));
        ...
        public Contract<T> IsTrue(bool val, string property) =>
            IsTrue(val, property, NotificationsErrorMessages.IsTrueErrorMessage(property));
        ...
        public Contract<T> IsNull(bool? val, string property) =>
                IsNull(val, property, NotificationsErrorMessages.IsNullErrorMessage(property));
        ...
        public Contract<T> IsNotNull(bool? val, string property) =>
            IsNotNull(val, property, NotificationsErrorMessages.IsNotNullErrorMessage(property));
