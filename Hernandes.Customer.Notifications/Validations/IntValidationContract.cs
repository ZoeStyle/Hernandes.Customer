...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(int val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (int)comparer, key, NotificationsErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(int val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (int)comparer, key, NotificationsErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(int val, string key) =>
            IsMinValue(val, key, NotificationsErrorMessages.IsMinValueErrorMessage(key, int.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(int val, string key) =>
            IsNotMinValue(val, key, NotificationsErrorMessages.IsNotMinValueErrorMessage(key, int.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(int val, string key) =>
            IsMaxValue(val, key, NotificationsErrorMessages.IsMaxValueErrorMessage(key, int.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(int val, string key) =>
            IsNotMaxValue(val, key, NotificationsErrorMessages.IsNotMaxValueErrorMessage(key, int.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(int val, float comparer, string key) =>
            AreEquals(val, (int)comparer, key, NotificationsErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(int val, float comparer, string key) =>
            AreNotEquals(val, (int)comparer, key, NotificationsErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(int val, float start, float end, string key) =>
            IsBetween(val, (int)start, (int)end, key, NotificationsErrorMessages.IsBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(int val, float start, float end, string key) =>
            IsNotBetween(val, (int)start, (int)end, key, NotificationsErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
