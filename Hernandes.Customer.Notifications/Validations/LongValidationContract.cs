...
namespace Hernandes.Customer.Notifications.Validations
{
    public partial class Contract<T>
    {
        ...
        public Contract<T> IsGreaterOrEqualsThan(long val, decimal comparer, string key) =>
            IsGreaterOrEqualsThan(val, (long)comparer, key, NotificationsErrorMessages.IsGreaterOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsLowerOrEqualsThan(long val, decimal comparer, string key) =>
            IsLowerOrEqualsThan(val, (long)comparer, key, NotificationsErrorMessages.IsLowerOrEqualsThanErrorMessage(key, comparer.ToString()));
        ...
        public Contract<T> IsMinValue(long val, string key) =>
            IsMinValue(val, key, NotificationsErrorMessages.IsMinValueErrorMessage(key, long.MinValue.ToString()));
        ...
        public Contract<T> IsNotMinValue(long val, string key) =>
            IsNotMinValue(val, key, NotificationsErrorMessages.IsNotMinValueErrorMessage(key, long.MinValue.ToString()));
        ...
        public Contract<T> IsMaxValue(long val, string key) =>
            IsMaxValue(val, key, NotificationsErrorMessages.IsMaxValueErrorMessage(key, long.MaxValue.ToString()));
        ...
        public Contract<T> IsNotMaxValue(long val, string key) =>
            IsNotMaxValue(val, key, NotificationsErrorMessages.IsNotMaxValueErrorMessage(key, long.MaxValue.ToString()));
        ...
        public Contract<T> AreEquals(long val, float comparer, string key) =>
            AreEquals(val, (long)comparer, key, NotificationsErrorMessages.AreEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> AreNotEquals(long val, float comparer, string key) =>
            AreNotEquals(val, (long)comparer, key, NotificationsErrorMessages.AreNotEqualsErrorMessage(val.ToString(), comparer.ToString()));
        ...
        public Contract<T> IsBetween(long val, float start, float end, string key) =>
            IsBetween(val, (long)start, (long)end, key, NotificationsErrorMessages.IsBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
        ...
        public Contract<T> IsNotBetween(long val, float start, float end, string key) =>
            IsNotBetween(val, (long)start, (long)end, key, NotificationsErrorMessages.IsNotBetweenErrorMessage(key, start.ToString(NotificationsFormats.DateTimeFormat), end.ToString(NotificationsFormats.DateTimeFormat)));
