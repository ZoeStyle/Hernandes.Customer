...
{
    public static class NotificationsErrorMessages
    {
        ...
        public static string IsCPFLocalizationErrorMessage = "should be a social security number";
        public static string IsCNPJLocalizationErrorMessage = "should be a CNPJ number";
        public static string IsRGLocalizationErrorMessage = "should be a RG number";
        ...
        public static string IsCPFErrorMessage(string key) => $"{key} {IsCPFLocalizationErrorMessage}";
        public static string IsCNPJErrorMessage(string key) => $"{key} {IsCNPJLocalizationErrorMessage}";
        public static string IsRGErrorMessage(string key) => $"{key} {IsRGLocalizationErrorMessage}";
    }
}
